...
int main()
{
    ...
    // if (cpid == 0) {
        ...
        char *filename12 = (char *) vm_map(nullptr, 0);
        char *filename22 = (char *) vm_map(nullptr, 0);

        /* Write the name of the file that will be mapped */
        strcpy(filename12, "data1.bin");
        strcpy(filename22, "data2.bin");
        
        char *p2 = (char *) vm_map (filename12, 0);
        char *r2 = (char *) vm_map (filename12, 2);
        char *s2 = (char *) vm_map (filename12, 2);

        char *q2 = (char *) vm_map (filename22, 0);
        char *t2 = (char *) vm_map (filename22, 3);
        char *u2 = (char *) vm_map (filename22, 3);
